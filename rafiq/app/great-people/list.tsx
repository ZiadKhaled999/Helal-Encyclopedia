...
export default function GreatPeopleListScreen() {
  const renderItem = ({ item }: { item: GreatPerson }) => (
    <Link href={`/great-people/${item.id}` as any} asChild>
  ...
  return (
    <ScreenWrapper headerComponent={<BackHeader title="أعظم 100 رجل في الإسلام" />}>
