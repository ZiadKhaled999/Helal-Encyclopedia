...
export default function WhoListScreen() {
  const renderItem = ({ item }: { item: WhoChapter }) => (
    <Link href={`/prophet/who/${item.id}` as any} asChild>
  ...
  return (
    <ScreenWrapper headerComponent={<BackHeader title="من هو محمد رسول الله" />}>
